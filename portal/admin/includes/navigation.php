    ...
    <ul class="nav user-menu float-right">
        <li class="nav-item dropdown d-none d-sm-block">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                ...
                <span class="badge badge-pill bg-danger float-right"><?php echo $row['total']; ?></span>
            </a>
            <div class="dropdown-menu notifications">
                ...
                <div class="drop-scroll">
                    <?php
                    $result = $pdo->prepare("SELECT e.*, a.agency_name FROM emergency e INNER JOIN agency a ON e.agency_id = a.agency_id WHERE status = 'Pending' ORDER BY id DESC");
                    $result->execute();
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details">
                                                There is a <?php echo $row['case_severity']; ?> emergency at
                                                <span class="noti-title"><?php echo $row['address']; ?>, <?php echo $row['state']; ?></span>.
                                                The <span class="noti-time"><?php echo $row['agency_name']; ?></span> is needed.
                                            </p>
                                            <p class="noti-time">
                                                <span class="notification-time"><?php echo $row['date']; ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </a>
