                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="../../uploads/team-1.jpg" alt=""></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">Allen's Group</h3>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><a href="https://www.facebook.com/allennazarhene.pascual">Allen Nazarhene Pascual</a></span>
                                                    <span class="title">Social Media:</span>
                                                    <span class="text"><a href="https://www.facebook.com/edra.deguzman">Edralene De Guzman</a></span>
                                                     <span class="title">Social Media:</span>
                                                    <span class="text"><a href="https://www.facebook.com/alliahmher.domindiano">Alliah Mher Domindiano</a></span>

                                                </li>
                                                <li>
                                                    <span class="title">Phone:</span>
                                                    <span class="text">+69 968 215 7159</span>
                                                </li>
                                                <li>
                                                    <span class="title">Address:</span>
                                                    <span class="text">Cupang Barangay Hall, M. L. Quezon Street, Mullet Compound, Cupang, Muntinlupa District 2, Muntinlupa, Southern Manila District, Metro Manila, 1771, Philippines</span>
                                                </li>
