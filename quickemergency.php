...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <?php if (get("success")): ?>
                            <div>
                                <?= App::message("success", "Your request has been successfully submitted to the nearest agency ,help is on the way") ?>
                            </div>
                        <?php endif; ?>
            ...
            <?php include 'portal/users/includes/message.php'; ?>
        </div>
    </div>
    <div class="sidebar-overlay" data-reff=""></div>
    <script src="portal/users/assets/js/jquery-3.2.1.min.js"></script>
    <script src="portal/users/assets/js/popper.min.js"></script>
    <script src="portal/users/assets/js/bootstrap.min.js"></script>
    <script src="portal/users/assets/js/app.js"></script>
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const defaultCoordinates = [14.412808484141289, 121.03269624150629]; // Default coordinates (Cebu City)
